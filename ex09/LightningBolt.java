...
public class LightningBolt implements Skill{
    ...
    public void use(Character attacker, Character target){
        ...
        System.out.println(attacker.getName() + " uses Lightning Bolt on " + target.getName() + " for " + (int)damage + " damage.");
    }
}
